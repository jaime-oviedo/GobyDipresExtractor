...
public class BudgetLawCsvFilesDownloader extends AbstractDownloader {
  ...
  public void download() throws DownloadException {
    ...
    try {
      while ((l = extractionListFileStream.readLine()) != null) {
        ...
        BudgetLawCsvFilesDownloader.log
            .finest(new StringBuffer("Archivo agregado a la lista de descarga:")
                .append(l).toString());
      }
    } catch (IOException e) {
      // TODO Auto-generated catch block
    ...
    if (useTimestamp) {
      ...
      setDestination(new StringBuffer(baseDestination).append('-')
    ...
    while (i.hasNext()) {
      ...
      String sourceFile = new StringBuffer(documentsSource).append('/')
          .append(fileName).toString();
      BudgetLawCsvFilesDownloader.log
          .finest(new StringBuffer("Se descargará el siguiente archivo:")

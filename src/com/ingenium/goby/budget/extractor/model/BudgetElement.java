 ...
 * 
 * @author Jaime Oviedo
 * @uml.annotations derived_abstraction="platform:/resource/goby-design/budget-extractor.emx#_UZ4ZEEquEeeJsdrfgQXeQw"
...
public class BudgetElement {
  ...
  /**
   * <!-- begin-UML-doc --> <!-- end-UML-doc --> Creates a new instance of the class BudgetElement.
   * 
   * @param element
   ...
   * </p>
   * <!-- end-UML-doc --> Creates a new instance of the class BudgetElement.
   * 
   * @param number
   *          <p>
   *          the number that identifies the element within his hierarchical level

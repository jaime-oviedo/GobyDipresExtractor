 ...
 * 
 * @author joviedo
 * @uml.annotations derived_abstraction="platform:/resource/goby-design/goby-classifier-extractor.emx#_UXJ1MEquEeeJsdrfgQXeQw"
...
public class BudgetClassifiersCatalog {
  ...
  /**
   * <!-- begin-UML-doc --> grega&nbsp;un&nbsp;item&nbsp;al&nbsp;subtitulo&nbsp;identificado.<br>
   * <br>
   * <br>
   * <br>
   * <br>
   * @param&nbsp;numeroSubtitulo<br>
   * <br>
   * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;identificador&nbsp;del&nbsp;subtitulo<br>
   * <br>
   * @param&nbsp;item<br>
   * <br>
   * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;el&nbsp;item&nbsp;a&nbsp;agrega <!--
  ...
  /**
   * <!-- begin-UML-doc --> grega&nbsp;una&nbsp;asignación&nbsp;al&nbsp;item&nbsp;identificado.<br>
   * <br>
   * <br>
   * <br>
   * <br>
   * @param&nbsp;numeroSubtitulo<br>
   * <br>
   * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;el&nbsp;subtitulo&nbsp;al&nbsp;que&nbsp;pertenece&nbsp;el&nbsp;item<br>
   * <br>
   * @param&nbsp;numeroItem<br>
   * <br>
   * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;el&nbsp;item&nbsp;identificador<br>
   * <br>
   * @param&nbsp;asignacion<br>
   * <br>
   * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;la&nbsp;asignación&nbsp;a&nbsp;agrega
   * <!-- end-UML-doc -->
   * 
   * @param subtitleNumber
   * @param itemNumber
